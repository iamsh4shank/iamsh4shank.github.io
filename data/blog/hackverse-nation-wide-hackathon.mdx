...
summary: 'Participated in HackVerse a hackathon'
...
<Image
  alt={`Image`}
  src={`/static/images/hackverse/hackverse2.jpg`}
  width={720}
  height={370}
  priority
/>  
...
<Image
  alt={`Image`}
  src={`/static/images/hackverse/hackverse3.jpg`}
  width={720}
  height={370}
  priority
/>  
...
<Image
  alt={`Image`}
  src={`/static/images/hackverse/Hackverse6.jpeg`}
  width={720}
  height={370}
  priority
/>  
...
<Image
  alt={`Image`}
  src={`/static/images/hackverse/Hackverse4.jpg`}
  width={720}
  height={370}
  priority
/> 
...
<Image
  alt={`Image`}
  src={`/static/images/hackverse/hackverse1.JPG`}
  width={720}
  height={370}
  priority
/> 