...
<div class="text-center">
    {% include figure.html path="assets/img/adversarial_ml/p1/indigo.png" class="img-fluid rounded z-depth-1" %}
</div>
...
So what did it actually classified as - 
```python
...
But this is how chickadee looks like - 

<div class="text-center">
    {% include figure.html path="assets/img/adversarial_ml/p1/chickadee.jpg" class="img-fluid rounded z-depth-1" %}
</div>

And this is how it actually looks likes after adding the perturbation
